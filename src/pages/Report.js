...
const Report = () => {
  ...
  const printDoc = () => {
    ...
    const options = {
      filename: 'evaluation-de-consommation.pdf',
  ...
  const [infoClient, setInfoClient] = useState([
    {
      ...
      commentaire: "",
      recommandation: "",
      service :"Evaluation de consommation"
    }
  ])
  ...
  const dataPuiss = {
    labels: labelCourbePuiss,
    datasets: [
      {
        label: "Courbe de puissance(Wh)",
        data: courbePuissData, // Données de production solaire mensuelles
        backgroundColor: "rgb(255, 165, 0)",
        borderColor: "rgb(255, 165, 0)",
        borderWidth: 1,
      },
  ...
  const steps = [
    {
      target: '.chart-irradiation',
      content: 'Scroler à l\'intérieur du chart pour zoomer ou dezoomer.',
    },
    {
      target: '.month-result',
  ...
  return (
    <div className="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div className="body-wrapper">
        {/*  Header Start */}
        <Header step={"Rapport"} isHelp={helpBox} />
        {/*  Header End */}
        <div className="container-fluid" ref={refToPrint}>
          <div className='card p-2'>
            <div className="print-only">
              ...
              <div className="row">
                ...
                <div className="col-md-8">
                  ...
                  <div className='text-black bg-light p-3'>
                    <span className='me-4'>Latitude : {localisation.latitude}</span>
                    <span>Latitude : {localisation.longitude}</span>
                  </div>
                  </div>
              ...
              {!checked && dataEns && <div className="row mt-2">
                <div className="col-md-6">
                  <div className="card chart-irradiation">
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-6">
                  <BarChart data={dataPuiss} title="Courbe de puissance" />
                </div>
              </div>
            ...
            <div className="btn-print d-flex justify-content-end">
                ...
                <button className="btn btn-primary d-flex align-items-center print" data-bs-toggle="modal" data-bs-target="#mymodalcomponent"> Télécharger le resultat</button>
