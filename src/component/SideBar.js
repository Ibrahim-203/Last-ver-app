...
const SideBar = () => {
    const navContent = [
        {title : "Installation Solaire", link: "/", icon: "mdi:solar-panel"},
        {title : "Calcule consommation", link: "/calc-conso", icon: "game-icons:desk-lamp"},
        {title : "Dimentionnement onduleur", link: "/dim-ond", icon: "cbi:huawei-solar-inverter"},
        {title : "Dimentionnement batterie", link: "/dim-batt", icon: "fa6-solid:car-battery"},
          ...
          <nav className= "sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
              ...
              {navContent.map((item, index)=>(
                ...
                <NavLink className= "sidebar-link" to={item.link} aria-expanded="false">
                  <span>
